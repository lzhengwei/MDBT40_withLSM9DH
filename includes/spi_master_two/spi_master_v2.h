...
#define SPI_PSELSCK0 						4    
#define SPI_PSELMOSI0 					3
#define SPI_PSELMISO0						2
#define SPI_PSELSS0							1

#define SPI_PSELSCK1 						4
#define SPI_PSELMOSI1 					3
#define SPI_PSELMISO1						2
#define SPI_PSELSS1							1
#define SPI_OPERATING_FREQUENCY				0x00100000
 ...
 */
bool spi_master_tx_rx(uint32_t *spi_base_address, uint16_t transfer_size, const uint8_t *tx_data, uint8_t *rx_data,uint8_t index);
/**
 *@}
 **/
